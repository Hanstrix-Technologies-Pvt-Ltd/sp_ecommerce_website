...
export default function OP01OverGroundPuzzlePage() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        <BreadcrumbNav currentPage="OP – 01 OVER GROUND PUZZLE" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100">
                Over Ground Puzzle Parking Solution
              </p>
              <p className="text-lg text-blue-200 max-w-3xl mx-auto">
                The OP-01 Over Ground Puzzle system provides innovative surface-level puzzle parking solutions, combining automated vertical and horizontal movement with above-ground installation for maximum space efficiency and visual appeal.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <img
                    src="/assets/cars/imgi_41_bLOG-700x600.png"
                    alt="OP-01 Over Ground puzzle parking system showing surface-level puzzle structure"
