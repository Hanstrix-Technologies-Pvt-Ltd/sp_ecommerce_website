...
export default function S01TwoLevelStackPage() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <BreadcrumbNav currentPage="S – 01 TWO LEVEL STACK" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100">
                Efficient Two-Level Stacking Parking Solution
              </p>
              <p className="text-lg text-blue-200 max-w-3xl mx-auto">
                The S-01 Two Level Stack is a hydraulic parking lift designed to
                double your parking capacity by utilizing vertical space
                efficiently. Perfect for residential and commercial
                applications.
              </p>
            </div>
          </div>
